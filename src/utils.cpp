...
[[nodiscard]] std::vector<std::string> get_files(const std::string &path, bool recursive) {
...
[[nodiscard]] std::string CommandLine::get(const std::string &flag) const {
...
[[nodiscard]] bool CommandLine::has(const std::string &flag) const {
